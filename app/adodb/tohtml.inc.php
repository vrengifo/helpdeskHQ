...
function donde_estoy()
{
	...
	if($id_subaplicacion!="")
	{
		...
		$rs = &$conn->Execute($query);
		if (!$rs||$rs->EOF) die(texterror('Su sesión de Usuario ha expirado. <a href="logout.php">Click para Ingresar al Sistema</a>'));
				...
				if(($i==0) || ($i==($ncols-1)))
				{
				  ...
				  if($i==($ncols-1))
				  {
					...
					else
					{
						...
						$s .= "	<TD valign=top nowrap> <a href='#1' onClick='".$caux."'>Click aquí</a></TD>\n";
			...
			default:
				...
				if(($i==0) || ($i==($ncols-1)))
				{
				  ...
				  if($i==($ncols-1))
				  {
					...
					{
						$s .= "	<TD valign=top nowrap> <a href='#1' onClick=('" .$url_modify.$param_modify."&id=" .trim($v)."','".$title."','".$par1."','".$par2."')>Click aquí</a></TD>\n";
					}
				 }
				}
				else
		...
		for ($j=0;$j<count($arreglo[$i]);$j++) 
		{
		  ...
		  if(($j==0) || ($j==($ncols-1)))
		  {
			...
			if($j==($ncols-1))
			{
			 /* if(!$ventana)//para mostrar en otra ventana o no
			  {
				$s .= "	<TD valign=top nowrap> <a href='" .$url_modify."'>Click aquí</a></TD>\n";	
			  }
			  else
			  {
				$vvalor=trim($v);
			...
			default:
				...
				if($i==($ncols-1))
				{
				  if($i==($ncols-1))
				  {
					...
					{
						$s .= "	<TD valign=top nowrap> <a href='#1' onClick=fOpenWindow('" .$url_modify.$param_modify."&id=" .trim($v)."','".$title."','".$par1."','".$par2."')>Click aquí</a></TD>\n";
					}
				 }
				}
				else
...
sql;
		...
		echo $usuNombre; 
		echo '&nbsp;&nbsp;&nbsp;&nbsp;Última Actualización a :&nbsp;'.date("Y-m-d H:i:s").'</SPAN></TD>
...
cad;
	    $rs = &$conn->Execute($query);
	    if (!$rs||$rs->EOF) die(texterror('No existen submódulos.'));
		...
		echo '<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="3" CLASS="workarea">
				  <TR>
				    <TD>
			<!--                        
                        <a href="#" onclick="printWindow()">Vista de Impresión</a><a href="printpage.php">otro Print Preview</a>
                        -->
			';
		donde_estoy();
		echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		//echo '<a href="'.$script_print.'" onclick="printWindow()">Vista de Impresión</a>
		echo '
