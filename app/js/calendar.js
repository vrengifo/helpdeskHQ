...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode += ("<div align=center><TABLE border=1 class=\"boxborder\">");
...
Calendar.prototype.show = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0><TR><TD ALIGN=center>");
...
Calendar.prototype.showY = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=5><TR>");
	var j;
	for (i=0; i<12; i++) {
...
Calendar.prototype.cal_data = function() {
	...
	*/
	...
	for (j=vFirstDay; j<7; j++) {
		vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j) + "><FONT>" +
