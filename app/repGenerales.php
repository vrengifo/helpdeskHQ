...
?>
	  <!-- buscar -->
	  <form name="form1" method="post" action="repGenerales.php">
...
<table class="tab" >
  ...
  <?php
    $sqlSop=<<<mya
  select u.usu_nombre,u.usu_id,count(t.tic_id) 
  from ticket t, usuario u 
  where t.usu_asignado<>'' 
  and u.usu_id=t.usu_id 
  $filtroDesde 
  $filtroHasta 
  $filtroServicio 
...
<?php
  $cadXML=<<<mya
<chart palette='1' caption='Reporte General de Usuarios' shownames='1' showvalues='0'  numberPrefix='' showSum='1' decimals='0' overlapColumns='0'><categories>$auxXMLCat</categories>$auxXMLSerie</chart>
mya;
?>
