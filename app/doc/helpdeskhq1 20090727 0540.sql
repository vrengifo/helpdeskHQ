...
INSERT INTO `parametro` (`par_id`,`par_fecha`,`par_fechahora`,`par_fechaformato`,`par_fechasql`,`par_fechahorasql`,`par_sepdecimal`,`par_seplista`,`par_cuentamail`) VALUES 
 (1,'Y-m-d','Y-m-d H:i:s',NULL,NULL,NULL,'.',':','helpdesk@localhost');
...
INSERT INTO `ticket` (`tic_id`,`usu_id`,`tiptic_id`,`pri_id`,`ser_id`,`tic_resumen`,`tic_descripcion`,`tic_fechahoraapertura`,`tic_fechahoraultmodificacion`,`tic_fechasolucion`,`tic_fechacierre`,`tic_valorencuesta`,`usu_asignado`,`tipest_id`,`tic_fechahorainicio`,`tic_fechahorafin`) VALUES 
 ...
 (6,'vrengifo',1,4,3,'Problema de hardware','No arranca el equipo asignado a mi persona','2009-07-26 11:54:31','2009-07-26 16:28:22',NULL,NULL,NULL,'vrengifo','P','2009-07-27 07:00:00','2009-07-28 14:30:00'),
 (8,'vrengifo',2,1,4,'Ayuda urgente -> msg: no tiene autorizacion para realizar esta operacion','Ayuda urgente -> msg: no tiene autorizacion para realizar esta operacion cuando estoy tratando de ingresar informacion del paciente','2009-07-26 12:15:59','2009-07-26 14:52:15',NULL,'2009-07-26 14:52:15',NULL,'vrengifo','CE','2009-07-27 07:00:00','2009-07-27 11:00:00'),
 ...
 (11,'usuario',2,2,3,'otra prueba de asignacion','otra prueba de asignacion','2009-07-26 21:31:55',NULL,NULL,NULL,NULL,'vrengifo','A','2009-07-27 08:00:00','2009-07-27 16:00:00'),
